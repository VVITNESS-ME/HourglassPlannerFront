      ...
      <Dialog as="div" className="relative z-10" onClose={()=>{setTitle("");setLimit(4);setPassword("");setSecretRoom(false);onClose()}}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="border-4 border-black w-full max-w-md transform overflow-hidden rounded-sm bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <input
                    type="title"
                    className="w-full text-3xl p-2 border-4 border-black rounded mt-2"
                    placeholder="방 제목"
                    value={title}
