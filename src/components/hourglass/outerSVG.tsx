...
const OuterSVG: React.FC<SvgProps> = ({ wd }) => {
    ...
    <svg width={wd} height={wd} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="">
        ...
        <line x1="20" y1="13" x2="20" y2="47" style={{stroke: 'black', strokeWidth: '2', strokeLinecap: 'round'}}/>
        <line x1="20" y1="53" x2="20" y2="87" style={{stroke: 'black', strokeWidth: '2', strokeLinecap: 'round'}}/>
        <line x1="80" y1="13" x2="80" y2="47" style={{stroke: 'black', strokeWidth: '2', strokeLinecap: 'round'}}/>
        <line x1="80" y1="53" x2="80" y2="87" style={{stroke: 'black', strokeWidth: '2', strokeLinecap: 'round'}}/>
