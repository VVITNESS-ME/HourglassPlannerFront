...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="flex flex-row justify-between space-x-2 grow md:flex-col md:space-x-0 md:space-y-2 top-20 left-0 h-[610px] bg-wallpaper rounded-sm border border-gray-300">
