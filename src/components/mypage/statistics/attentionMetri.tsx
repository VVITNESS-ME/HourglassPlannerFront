...
const AttentionMetric: React.FC = () => {
  ...
  return (
    <div className="flex flex-col border w-full h-[253px] bg-mypage-layout mypage-md rounded p-4">
      <div>
        <p className="text-3xl font-semibold">집중도</p>
      </div>
      <div className="flex flex-col items-center justify-between h-full py-4">
        <p className="text-4xl"><strong>집중도:</strong> {attentionRatio.toFixed(0)}%</p>
        <p className="text-4xl"><strong>활동시간 시간:</strong> {Math.floor(totalTime / 3600)} 시간 {Math.floor((totalTime % 3600) / 60)} 분</p>
