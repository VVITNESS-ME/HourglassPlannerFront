...
const TilContentModal: React.FC<TilContentModalProps> = ({ isOpen, onClose, til }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-white border-4 border-black p-4 rounded mypage-md max-w-lg w-full">
        <h2 className=" border-2 border-black text-4xl mb-4">{til.title}</h2>
        <p className=" border-2 border-black text-gray-700 text-3xl">{formattedContent}</p>
