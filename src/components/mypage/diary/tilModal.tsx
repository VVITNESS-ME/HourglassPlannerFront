...
const TilModal: React.FC<TilModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
      ...
      <div className="bg-yellow-300 rounded p-8 mypage-md w-full max-w-4xl relative">
        <button
        ...
        <div className="flex">
          <div className="w-1/4 bg-yellow-400 p-4 rounded mr-4">
          ...
          <div className="flex-1 bg-white p-4 rounded mr-4">
            ...
            />
            <textarea
              className="w-full p-2 border border-gray-700 rounded mt-2 h-[200px] overflow-y-scroll"
