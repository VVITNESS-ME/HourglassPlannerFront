...
const UserMenu: React.FC<UserMenuProps> = ({ username }) => {
  ...
  return (
    <div className="flex flex-row">
      ...
      {currentPath=="/"?<div className="flex absolute right-40 top-24 w-72 h-20 border rounded-2xl text-balance text-xl bg-sandy-1 items-center justify-center"><p>오늘 예정된 일정이 있습니다</p></div>:null}
