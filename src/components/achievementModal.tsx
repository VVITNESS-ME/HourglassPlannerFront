    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
      <div className="relative bg-white rounded overflow-hidden mypage-md w-96 transform transition-all duration-300 ease-in-out scale-110">
        <div className="p-6 text-center relative z-10">
          ...
          <button
            onClick={onClose}
            className="px-4 py-2 bg-blue-500 text-black rounded shadow hover:bg-blue-700 transition-colors duration-300"
          >
            Close
          </button>
        </div>
        <div className="absolute inset-0 flex items-center justify-center z-0">
          <div className="absolute w-80 h-80 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 rounded blur-2xl opacity-70 animate-spin-slow"></div>
        </div>
      </div>
      {/* 빵빠레 효과 추가 */}
